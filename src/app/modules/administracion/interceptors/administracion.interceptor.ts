...
@Injectable()
export class AdministrationInterceptor implements HttpInterceptor {
...
export const AdministrationInterceptorProvider = [{ provide: HTTP_INTERCEPTORS, useClass: AdministrationInterceptor, multi: true }];
